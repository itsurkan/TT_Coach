"""
TableDetector YOLO (TTHQ model) — run on a video and export to _table_yolo_tthq.json.

Usage:
    python scripts/run_table_yolo_tthq.py                          # all videos
    python scripts/run_table_yolo_tthq.py IMG_6332                  # single video
"""
...
MODEL_PATH = PROJECT_ROOT / "models/table_keypoints_tthq/best.pt"
...
def process_video(model, video_dir, num_samples):
    ...
    out_path = video_dir / f"{folder_name}_table_yolo_tthq.json"
