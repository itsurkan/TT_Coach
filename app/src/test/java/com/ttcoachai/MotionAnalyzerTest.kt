...
// removed to shrink the APK). See CLAUDE.md.
/*
...
class MotionAnalyzerTest {
    ...
    private fun createLandmark(x: Float, y: Float, z: Float = 0f): Landmark3D {
        return Landmark3D(x = x, y = y, z = z, visibility = 1f, presence = 1f)
    }

    private fun createDummyLandmarks(): List<Landmark3D> {
        // Create 33 landmarks
